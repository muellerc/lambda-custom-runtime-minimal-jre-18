...
public class InfrastructureStack extends Stack {
    ...
    public InfrastructureStack(final Construct scope, final String id, final StackProps props) {
        ...
        Function exampleCustomRuntime = new Function(this, "LambdaCustomRuntimeMinimalJRE18", FunctionProps.builder()
                .functionName("lambda-custom-runtime-minimal-jre-18")
                .description("lambda-custom-runtime-minimal-jre-18")
